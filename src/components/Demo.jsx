...
const Demo = () => {
  ...
  return (
    <>
      <div className='h-[114vw] md:h-[80vw] hidden xl:block'>
      ...
      <div>
        <div className='flex xl:hidden flex-col md:flex-row items-center'>
          <div className='w-full md:w-1/2 flex flex-col md:flex-row'>
            <div className='flex w-full md:w-1/6 justify-center items-center'>
              <p className='text-black font-josefinSlab font-extrabold text-2xl md:rotate-90 md:whitespace-nowrap md:-ml-4'>About Me</p>
            </div>
            <div className='h-[400px] md:h-full w-full md:w-5/6'>
              <img
                src="https://images.pexels.com/photos/906457/pexels-photo-906457.jpeg?auto=compress&cs=tinysrgb&w=600"
                alt="hello"
          ...
          <div className='w-full md:w-1/2'>
            <p className='text-left px-2 pt-4 text-2xl font-josefinSlab'>Hello, I'm Peter Parker.</p>
            <p className='text-left text-[1rem] px-2 py-2 font-josefinSlab'>
              From the very first click of the camera to the present day, our photography journey has been one of passion,
              creativity, and dedication. We started with a simple desire to capture the beauty of the world around us, and
              this hobby soon blossomed into a professional endeavor. Each photograph we take is not just a picture but a piece
              of art that tells a story and evokes emotions. Our work is driven by the inspiration behind every shot, whether it's
              the serene beauty of nature, the vibrant energy of urban life, or the intimate moments of a special occasion. We believe
              in capturing moments and creating memories that last a lifetime, and we strive to reflect this in every project we
              undertake. Join us as we continue to explore and share the world through our lens, one photograph at a time.
            </p>
          </div>
        </div>

        <div className='xl:hidden pt-20 pb-10 lg:pt-40 bg-gray-100 w-full flex flex-wrap items-center justify-center gap-4 lg:gap-10'>
          {[1, 2, 3, 4].map((item, index) => (
            <div
              key={index}
              className='w-[220px] h-[200px] sm:w-[300px] sm:h-[300px] md:h-[230px] md:w-[160px] bg-white group overflow-hidden'
            >
              <img
                src={getImgSrc(index)}
                alt="hello"
                className='h-3/4 w-full object-cover transition-transform duration-300 ease-in-out transform group-hover:scale-110 group-hover:cursor-pointer'
              />
              <p className='text-black text-[0.75rem] sm:text-[1rem] italic font-josefinSlab pt-3'>Savannah, GA</p>
              <p className='text-black text-[0.75rem] sm:text-[1rem] font-josefinSlab pb-10 sm:pb-20'>BRE & BILLY</p>
            </div>
          ))}
        </div>
      </div>
