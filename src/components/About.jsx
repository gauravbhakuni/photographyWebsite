...
const About = () => {
  return (
    <div className="text-gray-800">
      {/* Header Section */}
      <div className="px-10 relative h-screen bg-center">
        <div className="absolute inset-0 bg-black"></div> {/* Use absolute positioning */}
        <div className="relative flex items-center justify-center h-full"> {/* Ensure higher z-index */}
          <h1 className="text-white text-center text-4xl md:text-6xl font-bold">A Journey Through the Lens</h1>
        </div>
      </div>
